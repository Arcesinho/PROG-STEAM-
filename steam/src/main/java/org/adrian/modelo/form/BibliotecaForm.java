...
public record BibliotecaForm(Long id, Long idUsuario, Long idJuego, LocalDateTime fechaAdquisicion, Double horasJuego, Optional<LocalDateTime> ultimaFechaJuego, EstadoInstalacionBiblioteca.ESTADO_INSTALACION estadoInstalacion) {
